...
public class ViewBio : MonoBehaviour {
	...
	public IEnumerator DisplayABio(int whatBio){
        ...
        Debug.Log("Display " + PokemonData.IndexToMon(whatBio) +  "'s bio. This Pokemon " + (entry.seen && entry.caught ? "has been seen and caught." : entry.seen ? "has been seen." : "has not been seen or caught."));
